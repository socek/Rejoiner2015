...
<section id="resultsPage">
    ...
    <!-- PIXY BEAUTY -->
    <div class="results-story animateblock">
        <img alt="Pixy Beauty" class="logo" src="/img/results/logos/px.png" draggable="false">
        <h3>$43 Generated for Every $1 Spent</h3>
        <p class="results-quote">“With very little input, the Rejoiner team helped us troubleshoot & solve some integration issues in addition to developing a remarketing program that matched our brand beautifully. They are truly a ‘one-stop-shop’ for a cart abandonment program and could not be easier to work with. It’s great to work with true experts.”</p>
        <p class="who museo">FELIX STRAND, eCOMMERCE MARKETING</p>
    </div>
    <!-- VTECH -->
    <div class="results-story wow animateblock">
        <img alt="Vtech" class="logo" src="/img/results/logos/vt.png" draggable="false">
        <h3>Over $60,000 Recovered on Black Friday... Alone</h3>
        <p class="results-quote">“Rejoiner's abandoned cart retargeting platform was a critical part of our email strategy during the holiday season. Implementation was fast and we started seeing results immediately. Even better, the ROI was clear and tangible. Rejoiner's platform was easy to work with and flexible enough to meet our unique retargeting requirements.”</p>
