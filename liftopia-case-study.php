...
<section id="special-page-section">
    ...
    <div class="pasty-nav">
        <div class="content skybg">
            <a class="start" href="#intro">Background</a>
            <a href="#opportunity">The Opportunity</a>
            <a href="#deployment">Deployment</a>
            <a href="#campaign">The Campaign</a>
            <a href="#results">The Results</a>
            <a id="download-guide" class="download-guide-cta" href="">Download Guide</a>
        </div>
    </div>

    <div id="opportunity" class="text-content">
    ...
    <div id="deployment" class="text-content skybg">
        <h5>DEPLOYMENT</h5>
    ...
    <div id="campaign" class="text-content">
        <h5>THE CAMPAIGN</h5>
    ...
    <div id="download-guide">
        <div>
            ...
            <div class="">
                <img src="" alt="Liftopia Case Study eBook" />
            </div>
        </div>
    </div>
    ...
    <div id="creative" class="text-content skybg">
        <h5>THE CREATIVE</h5>
        <img class="creative-01" src="" alt="Email One" />
        <img class="creative-02" src="" alt="Email Two" />
    </div>

    <div id="results" class="text-content">
        <h5>THE RESULTS</h5>
        <h2>How They Recovered $714,000+ In Revenue</h2>
        ...
        <img src="" alt="Liftopia Campaign Results" />
        <span class="caption">
    ...
    <div class="last-call darkpurple">
        <h3>
            Learned a lot? Sharing is caring.
            Send the eBook to a friend.
        </h3>
