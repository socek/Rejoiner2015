<?php
	$pageTitle = "Abandoned Cart Extension For Magento | Rejoiner";
	$metaDescription = "Rejoiner is a shopping cart abandonment extension to help online retailers and eCommerce companies running on Magento, reduce their cart abandonment rate and convert more abandoned carts into customers.";
	include("header.php");
?>


		
<section id="magentobanner">
	<div>
		<div id="magentotext">
	...
	<div>
		<div class="halfs-intro-holder cart-aband">
			...
			<div class="magentoUserLogos">
				<img src="img/magento/kontrolfreek-logo.png" draggable="false" alt="KontrolFreek logo">
				<img src="img/magento/padandquill-logo.png" draggable="false" alt="Pad & Quill logo">
				<img src="img/magento/ghurka-logo.png" draggable="false" alt="Ghurka logo">
				<img src="img/magento/murrays-cheese-logo.png" draggable="false" alt="Murray's Cheese logo">
			</div>
		</div>
	</div>
</section>
...
<section id="btm-quote" style="margin-top:4%;">
	<div>
		<h3 class="consumerRecover">Our Customers to Date have Recovered $40,193,359.89 Million in Cart Abandonment Revenue</h3>
		...
		<div id="magento-abandon" class="halfs-intro-holder cart-features">
			...
			<div class="half-row">
			    ...
			    <div  class="halfs">
			    	...
			    	<p>
			    		Rejoiner’s powerful automated campaigns allow you to send hyper segmented and personalized cart abandonment emails, that regenerate the user’s session on your site with a single click, making it easy for your customers to complete the checkout process.
					</p>
				</div>
			</div>
			...
			<div class="half-row">
			 	<div class="halfs">
			 		<h3>Find out where you’re leaking money with Rejoiner’s dashboard and funnel visualization.</h3>
			...
			<div class="half-row">
			    ...
			    <p>Rejoiner, once setup, is completely automated, works without you having to lift a finger, scaling up and down with your traffic so you won't tax your in-house team resources.</p>
				</div>	
			</div>   
			...
			<div class="half-row">
			    <div class="halfs">
			    	...
			    	<p>Segmentation enables you to target specific customer groups with your automated email campaigns. Selectively send campaigns to customers who have a cart that’s over a certain value or contains a specific product. The possibilities for segmentation are endless and the result is a more targeted, higher converting campaign.</p>
				</div>
				<div class="halfs">
			...
			<div class="half-row">
			    ...
			    <p>Identify a customer as soon as they enter an email into a form field, even if they don’t click submit - allowing you to follow up with more guests who abandon the checkout process and generate more revenue.</p>
				</div>
			</div> 
			...
			<div class="half-row">
			    ...
			    <p>Your Rejoiner dashboard tracks abandonment rate, email open rate, click-through rate, conversion rate, and more. Identify opportunities to optimize your campaign and drive more conversions.</p>
				</div>
				<div class="halfs">
			...
			<div class="half-row">
			    ...
			    <p>Need help getting started with strategy and best practices? Sign up now and our design and HTML professionals will help you get your first powerful segmented campaign up and running so you can start recovering lost revenue right away.</p>
				</div>
			</div>   
		</div><!-- end magento-abandon -->
	</div><!-- end recover -->
</section>
