...
<form action='//app.rejoiner.com/api/marketingsite/emailcourse/' method='post' id='_form_course' accept-charset='utf-8' enctype='multipart/form-data'>
      ...
      <div id='_field706'>
        <div id='compile706' class='_field _type_input'>
          <div class='_option'>
            ...
            <div id="start-course-tick"><img src="img/forms/chk-dark-green.png"></div>
