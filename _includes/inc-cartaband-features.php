...
<section id="home-feature-section">
	<div id="recover">
		<div class="halfs-intro-holder cart-features">
			<h3 class="taller">Our Customers to Date have Recovered $40,193,359.89 Million in Cart Abandonment Revenue</h3>
			...
			<div class="half-row">
			    ...
			    <div  class="halfs">
			    	...
			    	<p>Rejoiner’s powerful automated campaigns allow you to send hyper segmented and personalized cart abandonment emails, that regenerate the user’s session on your site with a single click, making it easy for your customers to complete the checkout process.</p>
				</div>
			</div>
