		...
		<header class="masthead clearfix">
			<div class="masthead-wrapper">
				...
				<nav class="primary-menu">
					...
					<a class="demo-request" href="/request-demo" onClick="ga('send', 'event', { eventCategory: 'mainsite', eventAction: 'navdemorequestclick', eventLabel: 'homepagefixednav'});">Request a Demo</a>
