...
<section id="securityPage">
	...
	<div class="security-goals">
		<p class="intro-note"><b>This policy is designed to cover the most frequently asked security questions in concise format</b>. Secondly, this policy can help you determine whether Rejoiner meets your organization’s security requirements.
			<b>The goal of our policy is to protect all individuals using our platform</b>, including subscribers and end customers, from data theft and other security threats that may undermine their right to privacy.</p>

		<h3>Our Security Planning and Response Team</h3>
		<p>Since we are small company, the responsibilities of maintaining our security requirements are shared by all members of our team. Biannually, our team meets to do a security risk assessment on our platform and determine areas where we need to proactively secure our application. Minutes of these meetings are accessible internally. 
			Any concerns or information you would like to pass on to our security team, please use the contact form <a style="text-transform:underline;" href="/contact" target="_blank">here</a>.
		</p>


		<h3>Platform and Infrastructure Hosting</h3>
		<p>
		Our cart abandonment platform is hosted at third party cloud provider known as Softlayer. Softlayer is responsible for all necessary infrastructure related to our private cloud, but is not responsible for our local private network or our system configuration. 
		Physical access is securely restricted to Softlayer’s data center and has many third party certifications, including PCI and ISO 27001 compliance. 
		For more information about Softlayer and the security of their platform, please access their security page <a style="text-transform:underline;" href="http://www.softlayer.com/compliance" target="_blank">here</a>.
		</p>

		<h3>Data Collection, Retention, and Usage</h3>
		<p>
		We collect and store data from two entities, subscribers, i.e purchasers of Rejoiner, and end-users, customers shopping on your website. 
		Subscribers of the Rejoiner platform will have access to our metrics and configuration dashboard. This dashboard stores the following data:
		</p>
		...
		<p>
		Data collected via our dashboard and API endpoint is stored in perpetuity on encrypted hard drives.  This includes backups of our database. We retain data even when a subscriber cancels their account and unsubscribes from our service. 
		All data, whether generated by the subscriber or the end user, is considered to be confidential, private, and proprietary. We do not share our data with third party services or anyone outside of the Rejoiner team. Internally, we use data for analytics purposes and improving the quality of our platform. 
		</p>
