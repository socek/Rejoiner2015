<meta name="robots" content="noindex">
		...
		<form style="margin-bottom:50px;" action='//rejoiner.activehosted.com/proc.php' method='post' id='_form_1197' accept-charset='utf-8' enctype='multipart/form-data'>
...
jQuery(document).ready(function($){
	...
	$('#cart-lookbook').on('click', function(event){
		if( $(event.target).is('.cd-popup-close') || $(event.target).is('#cart-lookbook') ) {
			event.preventDefault();
